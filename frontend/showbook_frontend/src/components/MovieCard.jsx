...
export default function MovieCard({ movie }) {
  ...
  return (
    <article className="group w-full  overflow-hidden rounded-2xl border border-white/10 bg-zinc-950 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-2xl">
